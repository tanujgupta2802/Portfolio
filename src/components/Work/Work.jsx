...
const Work = () => {
  ...
  return (
    <section
      id="work"
      className="py-24 pb-24 px-[12vw] md:px-[7vw] lg:px-[20vw] font-sans relative min-h-screen"
    >
      {/* Section Title */}
      ...
      {/* Projects Grid */}
      <div className="grid gap-12 grid-cols-2 md:grid-cols-2 lg:grid-cols-2">
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 p-4 overflow-y-auto">
          <div className="bg-gray-900 rounded-xl shadow-2xl lg:w-full w-[90%] max-w-3xl max-h-[90vh] overflow-y-auto">
            {/* Modal Header */}
            <div className="flex justify-between items-center p-4 sticky top-0 bg-gray-900 z-10 border-b border-gray-700">
              <button
                onClick={handleCloseModal}
                className="flex items-center gap-2 text-white hover:text-purple-500 transition-colors duration-200"
              >
                <svg
            ...
            <div className="w-full flex justify-center bg-gray-900 px-4 pt-2 pb-6 max-h-[50vh] overflow-hidden">
              <img
            ...
            <div className="lg:p-8 p-6">
              <h3 className="lg:text-3xl text-2xl font-bold text-white mb-4">
